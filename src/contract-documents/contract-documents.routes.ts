...
router.get(
  ...
  contractDocumentsController.getContractDocuments.bind(contractDocumentsController),
);
...
router.post(
  ...
  contractDocumentsController.uploadContractDocuments.bind(contractDocumentsController),
);
...
router.get(
  ...
  authenticateJWT,
  contractDocumentsController.downloadSingleDocument.bind(contractDocumentsController),
);
...
router.post(
  ...
  contractDocumentsController.downloadMultipleDocuments.bind(contractDocumentsController),
);
...
router.patch(
  ...
  contractDocumentsController.editContractDocuments.bind(contractDocumentsController),
);
